    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/consultees/**").hasAnyRole("ADMIN", "CONSULTANT")
                .requestMatchers(HttpMethod.GET, "/consultations/**").hasAnyRole("ADMIN", "CONSULTANT")
                .requestMatchers(HttpMethod.POST, "/consultations/**").hasAnyRole("ADMIN", "CONSULTANT")
                .requestMatchers(HttpMethod.PUT, "/consultations/**").hasAnyRole("ADMIN", "CONSULTANT")
